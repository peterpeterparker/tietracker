        ...
        <IonPage>
            ...
            <IonContent>
                <main className="ion-padding">
                    ...
                    <p>In order to give you the best possible experience using Tie Tracker, we collect information from your interactions with our network. We use common internet technologies, such as cookies and web server logs. We collect this basic information from everybody, whether they have an account or not.</p>
                    ...
                    <p>In order for you to create an account on Tie Tracker and use our Services, we need to collect and process certain information. Depending on your use of the Services, that may include:</p>
                    ...
                    <p>We may share certain aggregated, non-personally identifying information with others about how our users, collectively, use Tie Tracker. For example, we may share information pertaining to the popularity of different category of presentations.</p>

                    <h2>Third Party Vendors</h2>

                    <h3>Data Storage</h3>

                    <p>Tie Tracker uses third-party vendors and hosting partners for hardware, software, networking, storage, and related technology we need to run Tie Tracker. By using Tie Tracker Services, you authorize Tie Tracker to transfer, store, and use your information in the United States and any other country where we operate. All service providers and third-party vendors are required to meet our data protection standards.</p>

                    <h3>Site monitoring </h3>

                    <p>Tie Tracker uses a variety of third-party services to diagnose errors and improve the performance of our site. We aim to minimize the amount of personal information shared, but the information may include your IP address or other identifying information. All service providers and third-party vendors are required to meet our data protection standards.</p>

                    <h3>Third-Party Embeds</h3>

                    <p>Some of the content that you see displayed on Tie Tracker is not hosted by Tie Tracker. These “embeds” are hosted by a third-party and embedded in Tie Tracker. For example: YouTube videos, Giphy Gifs, Twitter tweets, or GitHub code that appear within a Tie Tracker presentation. These files send data to the hosted site just as if you were visiting that site directly. Tie Tracker does not control what data third parties collect in cases like this, or what they will do with it. Third-party embeds on Tie Tracker are not covered by this privacy policy; they are covered by the privacy policy of the third-party service. Be mindful when interacting with these services.</p>
                    ...
                    <p>When you interact with a transactional email sent from Tie Tracker (such as opening an email or clicking on a particular link in an email), we may receive information about that interaction.</p>

                    <h3>Non-administrative Emails from Tie Tracker</h3>

                    <p>Upon creating a Tie Tracker account, you will be opted into the Tie Tracker Newsletter and other non-administrative email. Your email address and user profile information may be stored by a third-party email provider such as MailChimp or Sendgrid. You can opt out of non-administrative emails such as digests, newsletters, and activity notifications through your account’s “Settings” page and at the link of the footer in any non-administrative email you receive from us.</p>

                    <p>When you interact with a non-administrative email sent from Tie Tracker (such as opening an email or clicking on a particular link in an email), we may receive information about that interaction.</p>
