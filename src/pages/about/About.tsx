            ...
            <IonContent>
                ...
                <main className="ion-padding">
                    ...
                    <ul className={styles.list}>
                        <li><span aria-label="checkmark" role="img" >✅</span> Simple work hours tracking</li>
                        <li><span aria-label="checkmark" role="img">✅</span> Assign time to clients and projects</li>
                        <li><span aria-label="checkmark" role="img">✅</span> Mark entries as billed</li>
                    </ul>
                    ...
                    <ul className={styles.list}>
                        ...
                        <li><span aria-label="checkmark" role="img">✅</span> Today's list of activities</li>
                        <li><span aria-label="checkmark" role="img">✅</span> Export open invoices to CSV timesheets</li>
                    </ul>
                    ...
                    <p><IonLabel>I, David Dal Busco, am the developer behind this application. I am a freelancer, full stack developer Web, PWA and Mobile iOS/Android, UX and IT consultant by day and the creator of <a href="https://deckdeckgo.com" target="_blank" rel="noopener noreferrer">DeckDeckGo</a> by night.</IonLabel></p>
